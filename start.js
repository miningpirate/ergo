...
var pool = Stratum.createPool({
    ...
    "address": "3WwjaerfwDqYvFwvPRVJBJx2iUvCjD2jVpsL82Zho1aaV5R95jsG", //Address to where block rewards are given
    ...
    "ports": {
        "8009": { //A port for your miners to connect to
            "diff": 2000000000, //the pool difficulty for this port
            /*
            ...
            * */
            ...
            "varDiff": {
                "minDiff": 200000000, //Minimum difficulty
                "maxDiff": 200000000000, //Network difficulty will be used if it is lower than this
                "targetTime": 15, //Try to get 1 share per this many seconds
                "retargetTime": 10, //Check to see if we should retarget every this many seconds
                "variancePercent": 30 //Allow time to very this % from target without retargeting
            }
        },
        "8008": { //Another port for your miners to connect to, this port does not use varDiff
            "diff": 2000000000 //The pool difficulty
        }
    },
